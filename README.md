## I inherited this project from [Resumable.js](https://github.com/23/resumable.js)
This is an Resumable.js realization as a typescript library based on [Typescript library starter](https://github.com/alexjoverm/typescript-library-starter)
